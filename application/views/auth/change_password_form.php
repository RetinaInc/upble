...
<div id="content">
	<div id="top" class="clearfix">
		<div class="span-16"><h1>Change Password</h1></div>
	...
	<div class="box">
		...
		<table class="user_table">
			<tr>
				<th><?php echo form_label('Old Password', $old_password['id']); ?></th>
			...
			<tr>
				<th><?php echo form_label('Confirm New Password', $confirm_new_password['id']); ?></th>
			...
			<tr><td>&nbsp;</td><td ><?php echo form_submit('change', 'Change Password'); ?></td><td>&nbsp;</td></tr>
		</table>
